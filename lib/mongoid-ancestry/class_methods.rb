  ...
  module Ancestry
    module ClassMethods
      def has_ancestry(opts = {})
        ...
        self.index({ ancestry_field => '2d' }, { :background => true })
        ...
        scope :roots, lambda { where(ancestry_field => nil) }
        ...
        scope :ordered_by_ancestry, lambda { asc(:"#{self.base_class.ancestry_field}") }
